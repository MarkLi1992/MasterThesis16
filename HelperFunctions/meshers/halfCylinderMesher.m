function [edof,coord,ex,ey,ez,dof,nel,ndofs,nno,...
    mesh, sideElements] = halfCylinderMesher( length, inner_radius, thickness, nelr, nelphi, nelx, el_nnor, el_nnophi, el_nnox, ndofsno)
...
ang_dif = (pi)/(totnnophi-1);
currendnode = 1; 

for ir = 1:totnnor
    currentRadius = cr(ir);
    acc_ang = -ang_dif + -pi/2;
    for i=1:totnnophi
