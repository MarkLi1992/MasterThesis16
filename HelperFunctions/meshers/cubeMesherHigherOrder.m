...
sideElements.side1 = []; sideElements.side2 = []; sideElements.side3 = [];
sideElements.side4 = []; sideElements.side5 = [];
%Side 1 elements
for iz = 1:nelz
    for iy = 1:nely
        temp = side1nodes(1, (1:2) +iy-1,  (1:2) +iz-1);
        sideElements.side1 = [sideElements.side1 , temp(:)];
    end
end
...
for iz = 1:nelz
    for iy = 1:nely
        ...
        sideElements.side2 = [sideElements.side2 , temp(:)];
    end
end
...
for iz = 1:nelz
    for ix = 1:nelx
        ...
        sideElements.side3 = [sideElements.side3 , temp(:)];
    end
end
...
for iz = 1:nelz
    for ix = 1:nelx
        ...
        sideElements.side4 = [sideElements.side4 , temp(:)];
    end
end
...
for ix = 1:nelx
    for iy = 1:nely
        ...
        sideElements.side5 = [sideElements.side5 , temp(:)];
    end
end
